        ...
        link_elements.forEach((element) => {
                ...
                urls.forEach((url) => {
                        ...
                        message_div.className =
                                "relative text-2xl md:text-4xl except-mobile font-kidwriting";
                        ...
                        if (url.startsWith("http")) {
                                ...
                                message_div.innerHTML = targetElement
                                        ? `Here should be rendered the '${url.trim()}' element.`
                                        : `Invalid ID or link: ${url.trim()}`;
                        }
